...
public class Engine {
    ...
    public String insert(String[] tokens) {
        ...
        CustomHashMap table = tables.get(tableName); // Assuming tables is a Map<String, CustomHashMap>
    ...
    public String update(String[] tokens) {
        ...
        // Parse WHERE conditions using parseUpdate
    ...
    public String create(String[] tokens) {
        ...
        CustomHashMap newTable = new CustomHashMap(tableName, columns);
